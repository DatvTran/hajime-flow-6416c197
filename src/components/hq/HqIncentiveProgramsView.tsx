  ...
  const programs: ProgramDef[] = useMemo(
    () => [
      ...
      },
      {
        ...
        members: `${mfrCount} distillery partners`,
  ...
  return (
    <HqOperatorPage className="space-y-6">
      ...
      <HqOperatorKpiGrid>
        ...
        <HqOperatorKpiCard icon={Users} tone="blue" label="Members enrolled" value={String(enrolled)} sub={t("reps, distributors, distillery partners, retail")} />
            ...
            <div key={p.id} className="hq-prog-card">
              <div className="hq-prog-header">
                <div
                  ...
                  style={
                    p.title.includes("Distillery Partner")
