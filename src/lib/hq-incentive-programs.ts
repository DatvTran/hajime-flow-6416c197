...
const BASE_PROGRAMS: Record<HqIncentiveProgramId, HqIncentiveProgramConfig> = {
  ...
  distributor: {
    ...
    tiers: [
      ...
      { id: "t2", name: "Silver", threshold: "94%+ fill", reward: "3% volume", memberCount: 0, color: "hsl(220 8% 60%)" },
      { id: "t3", name: "Gold", threshold: "97%+ fill · 94% OT", reward: "4% volume", memberCount: 0, color: "hsl(40 88% 42%)" },
  ...
  kura: {
    ...
    active: true,
    tiers: [
      { id: "t1", name: "Standard", threshold: "Onboarded distillery partner", reward: "¥1.5/btl", memberCount: 1, color: "hsl(var(--muted-foreground))" },
