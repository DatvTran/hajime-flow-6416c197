...
const RULES: { prefix: string; section: string; page: string }[] = [
  { prefix: "/manufacturer/product-requests", section: "Distillery", page: "New product requests" },
  { prefix: "/manufacturer/purchase-orders", section: "Distillery", page: "Production orders" },
  { prefix: "/manufacturer/market-demand", section: "Distillery", page: "Market demand" },
  { prefix: "/manufacturer/profiles", section: "Supply chain", page: "Distillery profiles" },
  { prefix: "/manufacturer/inventory", section: "Distillery", page: "Batch history" },
  { prefix: "/manufacturer/shipments", section: "Distillery", page: "Shipments" },
  { prefix: "/manufacturer/alerts", section: "Distillery", page: "Alerts" },
  { prefix: "/manufacturer/finance", section: "Distillery", page: "Payments & receipts" },
  { prefix: "/manufacturer/profile", section: "Account", page: "Profile" },
  { prefix: "/manufacturer", section: "Distillery", page: "Overview" },
  ...
  { prefix: "/inventory/add", section: "Brand", page: "Add SKU" },
  { prefix: "/inventory/sku/", section: "Brand", page: "Edit SKU" },
  { prefix: "/inventory", section: "Brand", page: "Product catalog" },
  { prefix: "/orders", section: "Command", page: "Distributor orders" },
  { prefix: "/accounts/add", section: "Network", page: "Add distributor" },
  { prefix: "/accounts", section: "Network", page: "Distributors" },
  { prefix: "/crm", section: "Network", page: "Sales reps" },
  { prefix: "/markets", section: "Command", page: "Markets & allocation" },
  { prefix: "/shipments", section: "Operations", page: "Shipments" },
  { prefix: "/reports", section: "Brand", page: "Analytics" },
  { prefix: "/alerts", section: "Insights", page: "Alerts hub" },
  { prefix: "/finance", section: "Insights", page: "Payments & AR/AP" },
  { prefix: "/incentives", section: "Brand", page: "Incentive programs" },
  { prefix: "/expo-leads", section: "Command", page: "Expo leads" },
  { prefix: "/settings", section: "Brand", page: "Settings" },
  { prefix: "/manufacturer/profiles", section: "Network", page: "Distilleries" },
  { prefix: "/", section: "Command", page: "Dashboard" },
];
